...
class glTF2ExportUserExtension:
    def __init__(self):
        ...
        self.hba_settings = bpy.context.scene.hba_settings
    ...
    def hubs_gather_gltf_hook(self, gltf2_object, export_settings):
        if not self.properties.enabled or not self.was_used:
            return
        hba_config = self.hba_settings.hba_config
        extension_name = hba_config["gltfExtensionName"]
        gltf2_object.extensions[extension_name] = self.Extension(
            name=extension_name,
            extension={
                "version": hba_config["gltfExtensionVersion"],
    ...
    def add_hubs_components(self, gltf2_object, blender_object, export_settings):
        ...
        hba_config = self.hba_settings.hba_config
        # registered_hubs_components = self.hba_settings.registered_hubs_components
        ...
        if component_list.items:
            ...
            for component_item in component_list.items:
                ...
                # component_definition = hba_config['components'][component_name]
                ...
                #     export_settings, blender_object, component, component_definition, hba_config)
